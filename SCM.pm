...
SCM - Dilettante Source Control Management interface module 

=head1 DESCRIPTION

SCM provides an abstraction for generic source/version control functionality required by the build system.
